...
async function openChat(id, name, contact, note) {
    ...
    // --- ĐOẠN MỚI THÊM: In SĐT và Ghi chú ra dưới tên khách hàng ---
    let extraInfo = '';
    ...
    // GỌI 2 HÀM NÀY ĐỂ TẢI LỊCH SỬ VÀ KẾT NỐI
    fetchHistory(id);
    connectWebSocket(id);
...
} // <--- BẠN ĐÃ BỊ THIẾU DẤU ĐÓNG NGOẶC NÀY Ở CODE CŨ!
        ...
        try {
            ...
            switch(data.type) {
                ...
                default:
                    ...
                    // ---> ĐOẠN CODE MỚI THÊM: Bật thông báo nếu tin nhắn NÀY LÀ CỦA KHÁCH GỬI
